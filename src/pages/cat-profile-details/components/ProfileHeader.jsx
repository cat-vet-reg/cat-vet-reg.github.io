    ...
    <div className="bg-card rounded-xl shadow-warm p-4 md:p-6 lg:p-8 mb-4 md:mb-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 md:gap-6">
        <div className="flex items-start gap-4 md:gap-6">
          <div className="flex-shrink-0 w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 bg-primary/10 rounded-xl flex items-center justify-center">
            {/* <Icon name="Cat" size={40} color="var(--color-primary)" className="md:w-12 md:h-12 lg:w-14 lg:h-14" /> */}
                            <img
                    src="https://images.unsplash.com/photo-1456082981076-c3f00302c876"
                    alt="CastraMap logo"
