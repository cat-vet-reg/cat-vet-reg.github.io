...
export const mapRecordToForm = (record) => { //Превръща данни от DB -> Форма
    ...
    return {
        ...
        species               : record.data?.species || "cat",
        gender                : record.data?.gender || "female",
        status                : record.data?.status || "recorded",
        castratedAt           : record.data?.castrated_at || "",
        staffSurgeon          : record.data?.staff_surgeon || "",
        locationCity          : record.data?.location_city || "",
        locationAddress       : record.data?.location_address || "",
        ownerId               : record.data?.owner_id || null,
        ownerName             : record.data?.owner_name || "",
        ownerPhone            : record.data?.owner_phone || "",
        hasComplications      : record.data?.has_complications || "N",
        livingCondition       : record.data?.living_condition || [],
        selectedComplications : record.data?.selected_complications || [],
        recordComplications   : record.data?.record_complications || "",
