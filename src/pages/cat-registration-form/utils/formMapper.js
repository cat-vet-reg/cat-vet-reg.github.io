...
export const mapRecordToForm = (record) => {
    ...
    return {
        ...
        selectedComplications: record.data?.selected_complications || record.selected_complications || [],
        recordComplications: record.data?.record_complications || record.record_complications || "",
        ...
        // Preserve any custom color logic if it exists in data
